...
# print(elections.candidates[elections.candidates.iloc[:, 0]=='b'].index.to_list()[0])
...
print(compute_elections(elections_2024))
print(compute_elections(elections_2024, report_file='results_2024_fixed.txt'))
